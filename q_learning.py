...
class QLearningAgent:
    ...
    def reset(self) -> None:
        ...
        self.q_table = np.random.randn(n_states, n_actions)
        ### END OF YOUR CODE ###
    ...
    def act(self, state: int, exploit: bool = False) -> int:
        ...
        if exploit == True:
            ...
            if random_val <= self.explore_rate:
    ...
    def learn(self) -> dict:
        ...
        q_2 = np.max(self.q_table[next_state], axis=1)

        td_error = reward + (self.discount * q_2) - q_1
